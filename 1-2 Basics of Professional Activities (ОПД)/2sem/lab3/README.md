...
Помимо всего прочего, LOOP можно [сломать](https://github.com/Zerumi/OPD-guide-RU-/blob/master/loop.md). Не доводите БЭВМ до нервного срыва, иначе она потом доведёт вас...
