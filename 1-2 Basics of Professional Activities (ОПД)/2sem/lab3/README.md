...
`I = 1 + N + M` - Общее кол-во вызовов = кол-во вызовов в Instruction Fetch (1) + Address fetch + Execution.
...
| -------------------------- | ---------------------- |
| Прямая ABS и относительная | 1                      |
| Косв отн. SP               | 1                      |
| Косв. отн.                 | 2                      |
| Косв. авто inc / dec       | 3                      |
| Прямая загрузка операнда   | сами подумайте 😏      |
